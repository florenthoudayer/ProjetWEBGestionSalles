...
use gestionBundle\Entity\Salles;
...
class SallesController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $salles = $em->getRepository('gestionBundle:Salles')->findAll();
    ...
    {
        $salle = new Salle();
        $form = $this->createForm('gestionBundle\Form\SallesType', $salle);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('salles_show', array('id' => $salle->getIdSalles()));
        }
    ...
    {
        $deleteForm = $this->createDeleteForm($salle);
        $editForm = $this->createForm('gestionBundle\Form\SallesType', $salle);
        $editForm->handleRequest($request);

        if ($editForm->isSubmitted() && $editForm->isValid()) {
            $this->getDoctrine()->getManager()->flush();

            return $this->redirectToRoute('salles_edit', array('id' => $salle->getIdSalles()));
        }
    ...
    private function createDeleteForm(Salles $salle)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('salles_delete', array('id' => $salle->getIdSalles())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
