...
class FormationController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('formation_show', array('id' => $formation->getIdFormation()));
        }
    ...
    public function editAction(Request $request, Formation $formation)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('formation_edit', array('id' => $formation->getIdFormation()));
        }
    ...
    private function createDeleteForm(Formation $formation)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('formation_delete', array('id' => $formation->getIdFormation())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
