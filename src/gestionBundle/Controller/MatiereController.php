...
use gestionBundle\Entity\Matiere;
...
class MatiereController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $matieres = $em->getRepository('gestionBundle:Matiere')->findAll();
    ...
    {
        $matiere = new Matiere();
        $form = $this->createForm('gestionBundle\Form\MatiereType', $matiere);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('matiere_show', array('id' => $matiere->getIdMatiere()));
        }
    ...
    {
        $deleteForm = $this->createDeleteForm($matiere);
        $editForm = $this->createForm('gestionBundle\Form\MatiereType', $matiere);
        $editForm->handleRequest($request);

        if ($editForm->isSubmitted() && $editForm->isValid()) {
            $this->getDoctrine()->getManager()->flush();

            return $this->redirectToRoute('matiere_edit', array('id' => $matiere->getIdMatiere()));
        }
    ...
    private function createDeleteForm(Matiere $matiere)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('matiere_delete', array('id' => $matiere->getIdMatiere())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
