...
use gestionBundle\Entity\Reservation;
...
class ReservationController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('gestionBundle\Form\ReservationType', $reservation);
    ...
    {
        $deleteForm = $this->createDeleteForm($reservation);
        $editForm = $this->createForm('gestionBundle\Form\ReservationType', $reservation);
